...
if ($missing.Count -gt 0) {
    ...
    Write-Host '  $env:R2_ACCOUNT_ID="..."; $env:R2_ACCESS_KEY_ID="..."; $env:R2_SECRET_ACCESS_KEY="..."; $env:R2_BUCKET_NAME="b28streamer"; .\scripts\set-vercel-r2-env.ps1' -ForegroundColor White
    exit 1
}
